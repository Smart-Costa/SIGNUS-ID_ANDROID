...
public class entidadaAjustarUbicacion {
    ...
    public entidadaAjustarUbicacion(String numero, String assetSysId, String idOficina,String oficinanombre,String descripcion) {
        this.Numero = numero;
