...
import com.uk.tsl.rfid.samples.tagkill.databinding.ActivityTagkillBinding;
...
public class TagKillActivity extends AppCompatActivity
{
    // Debugging
    private static final String TAG = "TagKillActivity";
    private static final boolean D = BuildConfig.DEBUG;

    private AppBarConfiguration appBarConfiguration;
    private ActivityTagkillBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        // Now build the UI
        binding = ActivityTagkillBinding.inflate(getLayoutInflater());
